...
<body>
            ...
            <div class="card">
                ...
                <form id="cliente-form">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="direccion-cliente" rows="4" placeholder="Dirección completa"></textarea>
                    </div>
    ...
    <script>
        ...
        function getClientTypeBadge(tipo) {
            const typeClasses = {
                'regular': 'client-type-regular',
                'preferencial': 'client-type-preferencial',
                'corporativo': 'client-type-corporativo'
            };
            
            return `<span class="client-type-badge ${typeClasses[tipo]}">${tipo}</span>`;
        }
        ...
        function renderClientes() {
            ...
            if (clientes.length === 0) {
                tbody.innerHTML = '<tr><td colspan="6" style="text-align: center; font-size: 1.3rem;">No hay clientes registrados</td></tr>';
                return;
            }
            ...
            clientes.forEach(cliente => {
                ...
                tr.innerHTML = `
                    ...
                    <td>${getClientTypeBadge(cliente.tipo)}</td>
                    <td>
